document.addEventListener('DOMContentLoaded', function() {
    // Пример доступного времени
    const availableTimes = [
        '10:00', '11:00', '12:00', '13:00', '14:00', 
        '15:00', '16:00', '17:00', '18:00', '19:00', '20:00'
    ];
    
    // Пример забронированных дат (в реальном приложении эти данные будут приходить с сервера)
    const bookedDates = [
        '2023-11-15', '2023-11-18', '2023-12-05', '2023-12-10'
    ];
